...
const ModalNewTask = ({ isOpen, onClose, id = null }: Props) => {
  ...
  const handleSubmit = async () => {
    ...
    await createTask({ title, description, status, priority, tags, startDate: formattedStartDate, dueDate: formattedDueDate, authorUserId: parseInt(authorUserId), assignedUserId: parseInt(assignedUserId), projectId: id !== null ? Number(id) : Number(projectId)});
  };
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} name="Create New Task">
      ...
      >
        ...
        {id === null && (
          <input   type="text"   className={inputStyles}   placeholder="ProjectId"   value={projectId}   onChange={(e) => setProjectId(e.target.value)} />
        )}
        <button
          type="submit"
